					...
					<div className="row" id="tabs">
						<div className="col-md-4">
							<ul>
								...
								<li>
									<a href="#tabs-3">
										Ceremonia religiosa <i className="fa fa-angle-right"></i>
									</a>
								</li>
								<li>
									<a href="#tabs-4">
								...
								<li>
									<a href="#tabs-5">
										Condolencia digital* <i className="fa fa-angle-right"></i>
									</a>
								</li>
								<li>
									<a href="#tabs-6">
								...
								<li>
									<a href="#tabs-8">
										Embalsamamiento <i className="fa fa-angle-right"></i>
									</a>
								</li>
							</ul>
						</div>
						<div className="col-md-8">
							<section className="tabs-content">
								...
								<article id="tabs-2">
									<img src="assets/images/servicio_02.png" alt="" />
									...
									<p>
										...
										<br />
										<br />
										Pellentesque pretium, massa at placerat vehicula, neque
										turpis pulvinar tortor, eget convallis lorem odio non
								...
								<article id="tabs-3">
									<img src="assets/images/servicio_03.png" alt="" />
									...
									<p>
										...
										nostra, per inceptos himenaeos. Nunc vel ultrices nulla, ac
										tincidunt eros. Aenean quis tellus velit. Praesent pretium
										justo non auctor condimentum.
									</p>
								</article>
								<article id="tabs-4">
									<img src="assets/images/servicio_04.png" alt="" />
									...
									<p>
										...
										<br />
										<br />
										Donec finibus maximus neque, vitae egestas quam imperdiet
										nec. Proin nec mauris eu tortor consectetur tristique. Etiam
										suscipit ante a odio consequat, in ornare lacus suscipit.
										Cras ac libero massa. Quisque rhoncus velit feugiat
										vulputate mollis. Donec nisl eros, malesuada sed nisi id,
										condimentum condimentum quam.
									</p>
								</article>
								<article id="tabs-5">
									<img src="assets/images/servicio_05.png" alt="" />
									...
									<br />
									<br />
									<p>*Exclusivo en Agencia Funeraria Naser Morelos</p>
								</article>
								<article id="tabs-6">
									<img src="assets/images/servicio_06.png" alt="" />
								...
								<article id="tabs-7">
									<img src="assets/images/servicio_07.png" alt="" />
									...
									<br />
									<br />
									<p>*Exclusivo en Agencia Funeraria Naser Aragón</p>
								</article>
								<article id="tabs-8">
									<img src="assets/images/servicio_08.png" alt="" />
